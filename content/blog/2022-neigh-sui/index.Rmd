---
title: Can your neighbourhood shape your suicide risk?
subtitle: Neighbourhood factors and suicidality
excerpt: Objective and subjective neighbourhood factors and suicidality, published in Psychological Medicine
...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="One of the more picturesque London neighbourhoods "}
knitr::include_graphics("featured.jpg")
```

Neighbourhoods cover the full spectrum of positive and negative factures, but does your neighbourhood affect your mental health? 
...
I have been very interested in understanding how place can affect our mental health. I know I felt different in each of my neighbourhoods but it is hard to know what exactly in these neighbourhoods made me feel connected, supported, happy, and healthy.

### Research question

Are neighbourhood factors, both subjective and objective, linked to rates of suicide thoughts and attempts? 
...
We used information collected in the Stockholm Public Health Cohort, including 20,764 people across 889 neighbourhoods in Stockholm county. We looked at objective and subjective neighbourhood factors: 
...
*Subjective neighbourhood factors:*

+   Trust in those living in your neighbourhood (trust, reciprocity, and bonds between neighbours)

+   Average trust in public and political institutions (confidence in official structures and institutions)

*Outcomes - suicidality*
We measured suicidal thoughts and attempts, collected in the self-report questionnaire in 2002, 2006, 2010, and 2014. 

### What did we find? 

We found that there was variation in suicidal thoughts and attempts across neighbourhoods, but that much of the  the neighbourhood variation in suicidality was explained by the clustering of people with similar characteristics (compositional). 

That said, higher levels of neighbourhood deprivation and lower average trust in neigbours also increased rates of suicidal thoughts and attempts.

### Read more

[Read the full paper in Psychological Medicine](https://www.cambridge.org/core/journals/psychological-medicine/article/objective-and-subjective-neighbourhood-characteristics-and-suicidality-a-multilevel-analysis/2AC473596E33C6C990E460665946F6BB)
