---
title: Trajectories of deprivation and population density before and after diagnosis with a psychotic disorder
author: J Dykxhoorn
date: '2023-10-15'
slug: []
categories:
  ...
  - Sweden
subtitle: ''
excerpt: 'Does exposure to differing trajectories of deprivation and population density affect rates of psychotic disorders?'
tags: []
draft: false
series: ~
layout: single
...
```{r, echo=FALSE, out.width="100%", fig.align = 'center', fig.cap="People on a cafe terrace by Elisabeth Epstein (1913)"}
knitr::include_graphics("elisabeth-epstein.png")
```
...
Interestingly, preivous research suggests that the relationship between environmental risk factors (deprivation and population density) are more strongly related to psychotic disorders (including schizophrenia) than other severe mental illnesses, like non-psychotic bipolar disorder. 
...
This [hopefully] makes more sense when you look at the figures. 
Here, for example, you see the exposure to deprivation over time from birth through age 14 (pre-diagnosis period).
...
```{r, echo=FALSE, out.width="100%", fig.align = 'center', fig.cap="Trajectories of deprivation before diagnosis, birth to age 14"}
knitr::include_graphics("dep_traj.png")
```
