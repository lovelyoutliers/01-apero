...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="Is there a link between urbanicity & deprivation"}
...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="Deprivation trajectories"}
