...
```{r, out.width="100%", fig.align = 'center', fig.cap='People on a cafe terrace by Elisabeth Epstein (1913)'}
...
```{r, out.width="100%", fig.align = 'center', fig.cap='Trajectories of deprivation before diagnosis, birth to age 14'}
