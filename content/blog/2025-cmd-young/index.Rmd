...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="Primary care-recorded CMD and CMD symptoms, by sex"}
...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="Primary care-recorded CMD and CMD symptoms, by age"}
...
```{r, echo=FALSE, out.width="75%", fig.align = 'center', fig.cap="Primary care-recorded CMD and CMD symptoms, by deprivation"}
